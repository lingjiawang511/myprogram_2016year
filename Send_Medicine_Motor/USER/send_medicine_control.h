...
#if CHANNEL_4 == 0
#define DEVICE5_MOTOR_RUN   		GPIO_SetBits(DEVICE4_MOTOR_PORT, DEVICE4_MOTOR_IO)
#define DEVICE5_MOTOR_STOP 			GPIO_ResetBits(DEVICE4_MOTOR_PORT, DEVICE4_MOTOR_IO)
#define DEVICE5_LIGHT_ON  			GPIO_SetBits(DEVICE4_LIGHT_PORT, DEVICE4_LIGHT_IO)
#define DEVICE5_LIGHT_OFF 			GPIO_ResetBits(DEVICE4_LIGHT_PORT, DEVICE4_LIGHT_IO)
