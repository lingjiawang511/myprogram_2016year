...
#else
#define	DEVICE3_KEY_IO					GPIO_Pin_8
#define	DEVICE3_KEY_PORT				GPIOA
#endif
...
#if CHANNEL_4 == 0
#define	DEVICE5_MOTOR_IO				GPIO_Pin_12
#define	DEVICE5_MOTOR_PORT			GPIOC
#define	DEVICE5_LIGHT_IO				GPIO_Pin_2
#define	DEVICE5_LIGHT_PORT			GPIOD
#define	DEVICE5_SENSOR1_IO			GPIO_Pin_5
#define	DEVICE5_SENSOR1_PORT		GPIOC
#define	DEVICE5_SENSOR2_IO			GPIO_Pin_11
#define	DEVICE5_SENSOR2_PORT		GPIOC
#define	DEVICE5_SENSOR3_IO			GPIO_Pin_9
#define	DEVICE5_SENSOR3_PORT		GPIOC
#define	DEVICE5_KEY_IO					GPIO_Pin_10
#define	DEVICE5_KEY_PORT				GPIOC
#endif
...
#if CHANNEL_4 == 0
#define DEVICE5_MOTOR_RUN   		GPIO_SetBits(DEVICE5_MOTOR_PORT, DEVICE5_MOTOR_IO)
#define DEVICE5_MOTOR_STOP 			GPIO_ResetBits(DEVICE5_MOTOR_PORT, DEVICE5_MOTOR_IO)
#define DEVICE5_LIGHT_ON  			GPIO_SetBits(DEVICE5_LIGHT_PORT, DEVICE5_LIGHT_IO)
#define DEVICE5_LIGHT_OFF 			GPIO_ResetBits(DEVICE5_LIGHT_PORT, DEVICE5_LIGHT_IO)
#define READ_DEVICE5_SENSOR1    GPIO_ReadInputDataBit(DEVICE5_SENSOR1_PORT,DEVICE5_SENSOR1_IO)
#define READ_DEVICE5_SENSOR2    GPIO_ReadInputDataBit(DEVICE5_SENSOR2_PORT,DEVICE5_SENSOR2_IO)
#define READ_DEVICE5_SENSOR3    GPIO_ReadInputDataBit(DEVICE5_SENSOR3_PORT,DEVICE5_SENSOR3_IO)
#define READ_DEVICE5_KEY    		GPIO_ReadInputDataBit(DEVICE5_KEY_PORT,DEVICE5_KEY_IO)
